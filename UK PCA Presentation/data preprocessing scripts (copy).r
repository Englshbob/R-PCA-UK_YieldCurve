...
if(action == "downloadallnominaldata"){
  ...
  xdest<-"/media/john/6E34B3A529A1D545/Data/BoE Data/glcnominalddata.zip"
  ...
  unzip("/media/john/6E34B3A529A1D545/Data/BoE Data/glcnominalddata.zip",overwrite=TRUE,exdir="/media/john/6E34B3A529A1D545/Data") 

  if (file.exists("/media/john/6E34B3A529A1D545/Data/temp.csv")){
    file.remove("/media/john/6E34B3A529A1D545/Data/temp.csv") # make sure that temp file is deleted
    }

  yield_curve_files <- as.character(unzip("/media/john/6E34B3A529A1D545/Data/BoE Data/glcnominalddata.zip", list = TRUE)$Name)
  ...
  write.table(r1,file="/media/john/6E34B3A529A1D545/Data/temp.csv",sep=",",append=TRUE) # write headers in to the csv file
  ...
  for (counter in 1:number.of.files){
    ...
    write.table(x=xlsx_load, file="/media/john/6E34B3A529A1D545/Data/temp.csv",append=TRUE,sep=",",row.names=FALSE,col.names=FALSE)
    file.remove(xl_path)
  }  
  ...
  if(dateloaded!=format(Sys.time(), '%Y%m%d')){
    ...
    xdest<-"/media/john/6E34B3A529A1D545/Data/BoE Data/latest-yield-curve-data.zip"
    download.file(url=xurl, destfile=xdest, quiet = FALSE, mode = "w", cacheOK = TRUE, extra = getOption("download.file.extra"))
    unzip("/media/john/6E34B3A529A1D545/Data/BoE Data/latest-yield-curve-data.zip",overwrite=TRUE,exdir="/media/john/6E34B3A529A1D545/Data")   
  ...
  boe_rates <- read.csv(file="/media/john/6E34B3A529A1D545/Data/temp.csv",sep=",",skip=0,header=TRUE)
  file.remove("/media/john/6E34B3A529A1D545/Data/temp.csv") # delete the temp file
...
if(action == "downloadallinflationdata"){
  ...
  xdest<-"/media/john/6E34B3A529A1D545/Data/BoE Data/glcinflationddata.zip"
  if (reloadHistoricMonths==TRUE){
    download.file(url=xurl, destfile=xdest, quiet = FALSE, mode = "w", cacheOK = TRUE, extra = getOption("download.file.extra"))
}
  unzip("/media/john/6E34B3A529A1D545/Data/BoE Data/glcinflationddata.zip",overwrite=TRUE,exdir="/media/john/6E34B3A529A1D545/Data") 
  
  if (file.exists("/media/john/6E34B3A529A1D545/Data/temp.csv")){
    file.remove("/media/john/6E34B3A529A1D545/Data/temp.csv") # make sure that test file is deleted
  }
  
  yield_curve_files <- as.character(unzip("/media/john/6E34B3A529A1D545/Data/BoE Data/glcinflationddata.zip", list = TRUE)$Name)
  ...
  boe_inflation <- read.csv(file="/media/john/6E34B3A529A1D545/Data/temp.csv",sep=",",skip=0,header=TRUE)
  file.remove("/media/john/6E34B3A529A1D545/Data/temp.csv") # delete the temp file
  }
  ...
  write.table(x=boe_inflation,file="/media/john/6E34B3A529A1D545/Data/inflationdukrates.csv", row.names=FALSE, sep=",")
  
  file.remove("/media/john/6E34B3A529A1D545/Data/allukrates.csv")  
  
  file.copy(from="/media/john/6E34B3A529A1D545/Data/inflationdukrates.csv",to="/media/john/6E34B3A529A1D545/Data/allukrates.csv",overwrite=TRUE)
...
if(action == "downloadallrealdata"){
  ...
  xdest<-"/media/john/6E34B3A529A1D545/Data/BoE Data/glcrealddata.zip"

  if (reloadHistoricMonths==TRUE){
    download.file(url=xurl, destfile=xdest, quiet = FALSE, mode = "w", cacheOK = TRUE, extra = getOption("download.file.extra"))
  }
  
  unzip("/media/john/6E34B3A529A1D545/Data/BoE Data/glcrealddata.zip",overwrite=TRUE,exdir="/media/john/6E34B3A529A1D545/Data") 
  
  if (file.exists("/media/john/6E34B3A529A1D545/Data/temp.csv")){
    file.remove("/media/john/6E34B3A529A1D545/Data/temp.csv") # make sure that test file is deleted
  }
  
  yield_curve_files <- as.character(unzip("/media/john/6E34B3A529A1D545/Data/BoE Data/glcrealddata.zip", list = TRUE)$Name)
  ...
  write.table(x=boe_inflation,file="/media/john/6E34B3A529A1D545/Data/realdukrates.csv", row.names=FALSE, sep=",")
  
  file.remove("/media/john/6E34B3A529A1D545/Data/allukrates.csv")  
  
  file.copy(from="/media/john/6E34B3A529A1D545/Data/realdukrates.csv",to="/media/john/6E34B3A529A1D545/Data/allukrates.csv",overwrite=TRUE)
  rm(xl_path,xlsx_load,xurl,xdest,yield_curve_files, boe_inflation, number.of.files,r1) # delete used objects
